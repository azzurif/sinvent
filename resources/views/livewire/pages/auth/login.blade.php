  ...
  <div class="md:flex md:items-center md:justify-center">
    <form class="md:w-96" wire:submit="login">
      ...
      <div>
        ...
        <x-text-input class="mt-1 block w-full h-8" id="email" name="email" type="email" wire:model="form.email"
      ...
      <div class="mt-4">
        ...
        <x-text-input class="mt-1 block w-full h-8" id="password" name="password" type="password"
